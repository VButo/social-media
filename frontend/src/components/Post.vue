<template>
    <div class="post">
        <div id="user-info" @click="visitProfile">
            <img :src="`https://social-media-neon-five.vercel.app/${post.profilePicture}`" id="profile-picture">
            <div id="user-data">
        ...
        <img v-if="post.image" :src="`https://social-media-neon-five.vercel.app/${post.image}`" alt="Post image" v-on:dblclick="toggleLike">
        <div>
